...
# -*- coding: utf-8 -*-
"""
    This is a bot for mini project
"""
import copy
import random
import time
            ...
            try:
                if figure[line][widther] == "*" and zone[line][widther] == ".":
                    return False,price
                        ...
                        and height>=line >= 0 and width>=widther >= 0:
                    counter += 1
                elif figure[line][widther] == "*" and (zone[line][widther] == \
...
def mover(player, field, field_height, field_width,\
    ...
    for heighter in range(-figure_height, field_height):
        for elem_index in range(-figure_width, field_width):
            status, price = checker(player, field, field_height, field_width, \
                                    elem_index, heighter, figure, figure_height, figure_width)
            if status == 1:
